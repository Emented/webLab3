 ...
 */
package com.emented.weblab3.database.jooq.tables.records;
...
public class HitsRecord extends UpdatableRecordImpl<HitsRecord> implements Record8<Integer, String, Double, Double, Double, OffsetDateTime, Long, Boolean> {
    ...
    /**
     * Setter for <code>s336189.hits.session_id</code>.
     */
    ...
    /**
     * Getter for <code>s336189.hits.session_id</code>.
     */
    ...
    @Override
    public Row8<Integer, String, Double, Double, Double, OffsetDateTime, Long, Boolean> valuesRow() {
    ...
    @Override
    public HitsRecord value2(String value) {
        setSessionId(value);
        return this;
    }
    ...
    @Override
    public HitsRecord values(Integer value1, String value2, Double value3, Double value4, Double value5, OffsetDateTime value6, Long value7, Boolean value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HitsRecord(Integer id, String sessionId, Double x, Double y, Double r, OffsetDateTime checkDate, Long executionTime, Boolean status) {
        super(Hits.HITS);
