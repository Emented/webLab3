...
public class Hits extends TableImpl<HitsRecord> {
    ...
    /**
     * The column <code>s336189.hits.session_id</code>.
     */
    public final TableField<HitsRecord, String> SESSION_ID = createField(DSL.name("session_id"), SQLDataType.VARCHAR.nullable(false), this, "");
